...
<html lang="en-us" id="extr-page">
	...
	<body id="login">
		...
		<header id="header">
			...
			<span id="extr-page-header-space"> <span class="hidden-mobile hiddex-xs">Need an account?</span> <a href="register.php" class="btn btn-primary">Register</a> </span>
											...
											<b class="tooltip tooltip-bottom-right">Don't forget your password</b> </label>
													...
													<label class="select">
														<select class="input-sm">
															<option value="0">Event Location</option>
