	...
	<body class="smart-style-2">
		...
		<header id="header">
			<div id="logo-group">
				...
				<span id="logo"> <img src="img/logo-blue.png" alt="SmartAdmin"> </span>
			...
			<div class="pull-right">
				...
				<form action="search.html" class="header-search pull-right">
					<input id="search-fld"  type="text" name="param" placeholder="Find Team Profiles">
					<button type="submit">
		...
		<div id="shortcut">
			<ul>
				<li>
					<a href="index.php" class="jarvismetro-tile big-cubes bg-color-blue"> <span class="iconbox"> <i class="fa fa-home fa-4x"></i> <span>Dashboard</span> </a>
				</li>
				<li>
					<a href="team.php" class="jarvismetro-tile big-cubes bg-color-orangeDark"> <span class="iconbox"> <i class="fa fa-users fa-4x"></i> <span>Team Profile</span> </span> </a>
				</li>
				<li>
					<a href="profile.php" class="jarvismetro-tile big-cubes bg-color-purple"> <span class="iconbox"> <i class="fa fa-user fa-4x"></i> <span>My Profile</span> </span> </a>
				</li>
			</ul>
		</div>
		<!-- END SHORTCUT AREA -->
