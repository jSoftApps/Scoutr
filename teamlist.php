										...
										<table id="datatable_fixed_column" class="table table-striped table-bordered" width="100%">
									        ...
									        <thead>
												<tr>
													...
													<th class="hasinput" style="width:17%">
														<input type="text" class="form-control" placeholder="Filter Starting Year" />
													</th>
												</tr>
									            <tr>
								                    <th data-class="expand">Team Name</th>
								                    <th>Team Number</th>
								                    <th data-hide="phone">Team Location</th>
								                    <th data-hide="phone">Starting Year</th>
									            </tr>
									        </thead>
                          ...
                          <tbody>
                            ...
                            if ($result->num_rows > 0) {
                              while($row = $result->fetch_assoc()) {
                                echo "<tr><td><a href='profile.php?=".$row["teamnumber"]."'>".$row["teamname"]."</td><td>".$row["teamnumber"]."</td><td>".$row["teamlocation"]."</td><td>".$row["startingyear"]."</td></tr>";
                              }
                            }
                            ?>
									        </tbody>
