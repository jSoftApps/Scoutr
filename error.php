...
<html lang="en-us" id="extr-page">
	<head>
		<meta charset="utf-8">
		<title>Registration Error | Scoutr</title>
			...
			<div id="content" class="container">
				...
				<div class="row">
					...
					<div class="col-xs-12 col-sm-12 col-md-5 col-lg-5">
                      ...
                      Looks like there was an error with registration. Try selecting a different username and trying again.
                    </div>
									</section>
								</fieldset>
								...
								<footer>
									<a href="register.php" class="btn btn-danger">Try Again</a>
								</footer>
							</form>
